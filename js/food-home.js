$(function(){
//	筛选事件
	$('.fav-title .fav-title-item').bind('click',function(e){
	...
	$('.fav-discon').bind('click',function(e){
		if(e.target==this){
			$('.fav-title').removeClass('fixed');
			$('.fav-title .fav-title-item').removeClass('active');
			$('.fav-discon').css('display','none');
	...
	$('.category-wrapper a,.biz-wrapper a,.sort-wrapper a').bind('click',function(e){
	...
	$('.switch-cont.input-checkbox').bind('click',function(e){
	...
	$('.csp-content .option-wrapper .option').bind('click',function(e){
		$(this).parents('.meal-number-option').find('.option').removeClass('selected');
		$(this).addClass('selected');
	});
	$('.csp-wrapper .operate .reset-button').bind('click',function(e){
	...
	$('.csp-wrapper .operate .save-button').bind('click',function(e){
		$('.fav-title').removeClass('fixed');
		$('.fav-title .fav-title-item').removeClass('active');
		$('.fav-discon').css('display','none');
	});
